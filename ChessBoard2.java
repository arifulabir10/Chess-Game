...
public class ChessBoard2 {
    ...
    public ChessBoard2(GridPane chessBoard, String theme){
    ...
    private void addPieces(){
        for(Square square : squares){
            ...
            if(square.y == 1){
                ...
                if(square.x == 2 || square.x == 7){
                    addPiece(square, new Kangaroo("black", square.x, square.y));
                }
                ...
                if(square.x == 2 || square.x == 7){
                    addPiece(square, new Kangaroo("white", square.x, square.y));
                }
                if(square.x == 0 || square.x == 9){
